    ...
    <section className="rounded border border-slate-800 bg-slate-900/20">
      ...
      {reason ? (
        ...
        <p className="mx-4 mb-3 rounded border border-slate-700 bg-slate-900/60 px-3 py-2 text-xs text-slate-400">
          ...
          Ordinary on a fresh install and while{' '}
          <code className="text-slate-300">WORKER_STRATEGY</code> is empty — but it is <em>not</em>{' '}
          the same as a compliant book, which is why every reading below is {UNKNOWN} rather than
          zero.
        </p>
      ) : null}
